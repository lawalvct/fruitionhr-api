...
class VacancyController extends Controller
{
    ...
    public function index(Request $request): mixed
    {
        ...
        $query = Vacancy::query()->with(['requisition', 'employmentType'])->withCount('applications')
    ...
    {
        return (new VacancyResource($this->recruitment->createVacancy($request->validated(), $request->user())->load(['requisition', 'employmentType'])->loadCount('applications')))
    ...
    public function update(VacancyRequest $request, Vacancy $vacancy): VacancyResource
    {
        ...
        return new VacancyResource($vacancy->refresh()->load(['requisition', 'employmentType'])->loadCount('applications'));
    }
