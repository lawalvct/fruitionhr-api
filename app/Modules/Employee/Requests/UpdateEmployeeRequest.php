...
class UpdateEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'assignment.branch_id' => ['nullable', 'integer', $this->tenantExists('branches')],
            'assignment.department_id' => ['nullable', 'integer', $this->tenantExists('departments')],
            'assignment.position_id' => ['nullable', 'integer', $this->tenantExists('positions')],
            'assignment.job_grade_id' => ['nullable', 'integer', $this->tenantExists('job_grades')],
            'assignment.employment_type_id' => ['nullable', 'integer', $this->tenantExists('employment_types')],
            'assignment.effective_from' => ['required_with:assignment', 'date'],
